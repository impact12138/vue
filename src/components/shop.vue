  ...
  <div class="hello" v-if=shop>
    <div>
      ...
      <el-button type="text" @click="centerDialogVisible = true">
        ...
        <p>{{shop.float_delivery_fee}} 月售{{ shop.recent_order_num }}单 {{shop.delivery_mode.text}} 约{{order_lead_time}}&nbsp;
        距离{{distance}}</p>
...
export default {
  ...
  mounted(){
    ...
    .then(response => {
        ...
        this.num = this.shop.activities.length;
